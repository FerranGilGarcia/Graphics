...
//metodos para calcular el rayo de luz
glm::mat4 Camera::getViewMatrix() const {
	return view_matrix; // Devuelve la matriz de vista actualizada
}

glm::mat4 Camera::getProjectionMatrix() const {
	return projection_matrix; // Devuelve la matriz de proyección actualizada
}

glm::vec3 Camera::getPosition() const {
	return eye; // Devuelve la posición de la cámara en el mundo
}
